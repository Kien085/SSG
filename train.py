...
import opts
import models #should I use the normal LSTM fron nn
from dataloader import *
import eval_utils_mem
import utils as utils
from rewards_mem import init_scorer, get_self_critical_reward
#convert graph features to sequence everything (LSTM) takes sequence as an input
try:
...
def train(opt):
    ...
    model = models.LSTM_mem4(opt).cuda()
    ...
    while True:
        ...
        #All of this stuff is for the bottom up features
        ...
        #This is where the sentence scene graph stuff is
        ...
        #need to change the model to not have the image features
        if not sc_flag:
            ...
            #Why does he have this here twice?
            # rela_data = {}
            # rela_data['att_feats'] = att_feats
            # rela_data['att_masks'] = att_masks
            # rela_data['rela_matrix'] = rela_rela_matrix
