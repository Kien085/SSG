...
if os.path.isfile(spice_sg_dict_raw_path) == 0:
	...
	num_ssg = 0
	print('load raw dict:')
	spice_dict_raw = np.load(spice_sg_dict_raw_path, allow_pickle=True)['spice_dict'][()]
...
if os.path.isfile(spice_sg_dict_path) == 0:
	...
	print('load dict:')
	spice_dict = np.load(spice_sg_dict_path, allow_pickle=True)['spice_dict'][()]
